...
const CreatePost = () => {
  ...
  return (
    <div className={styles.create_post}>
      <h2>CreatePost</h2>
      <p>Escrava sobre o que quiser e compartilhe  o seu conhecimento</p>
      <form onSubmit={handleSubmit}>
        ...
        <label>
          ...
          <input type="text" name="image" required placeholder="Insira uma imagem que presenta seu post"
